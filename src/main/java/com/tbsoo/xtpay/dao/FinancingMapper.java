...
import com.tbsoo.xtpay.model.Financing;
...
public interface FinancingMapper {
    @Delete({
        "delete from hc_financing",
        "where id = #{id,jdbcType=INTEGER}"
    })
    int deleteByPrimaryKey(Integer id);

    @Insert({
        "insert into hc_financing (id, product_no, ",
        "contract_no, borrow_reason, ",
        "name, category, borrower_id, ",
        "borrower_name, nature, ",
        "type, repayment, operator, ",
        "join_date, pub_date, ",
        "value_date, amount, ",
        ...
        "#{name,jdbcType=VARCHAR}, #{category,jdbcType=BIT}, #{borrowerId,jdbcType=INTEGER}, ",
        "#{borrowerName,jdbcType=VARCHAR}, #{nature,jdbcType=BIT}, ",
        "#{type,jdbcType=BIT}, #{repayment,jdbcType=BIT}, #{operator,jdbcType=INTEGER}, ",
        "#{joinDate,jdbcType=INTEGER}, #{pubDate,jdbcType=INTEGER}, ",
        "#{valueDate,jdbcType=INTEGER}, #{amount,jdbcType=DECIMAL}, ",
        ...
        "#{estimateInterest,jdbcType=DECIMAL}, #{isWelfare,jdbcType=BIT}, ",
        "#{remark,jdbcType=VARCHAR}, #{intro,jdbcType=LONGVARCHAR}, ",
    ...
    int insert(FinancingWithBLOBs record);

    @InsertProvider(type=FinancingSqlProvider.class, method="insertSelective")
    int insertSelective(FinancingWithBLOBs record);

    @Select({
        "select",
        "id, product_no, contract_no, borrow_reason, name, category, borrower_id, borrower_name, ",
        "nature, type, repayment, operator, join_date, pub_date, value_date, amount, ",
        "threshold_amount, increasing_amount, max_amount, raise_date, deadline, repayment_date, ",
        "guarantors_id, guarantors_name, guaranteed_amount, year_income, extra_year_income, ",
        "status, is_approve, audit_advice, conftime, fee, full_scale_date, payment_amount, ",
        "payment_date, is_retrial, retrial_advice, second_conftime, term_total, click_num, ",
        "overtime, series, template_id, proxy_id, is_preview_repayment, pay_interest_day, ",
        "min_repayment_date, finish_preview_repayment, preview_repayment_date, estimate_interest, ",
        "is_welfare, remark, intro, guarantors_advice, risk_control, material, repayment_remark, ",
        "month",
        "from hc_financing",
        "where id = #{id,jdbcType=INTEGER}"
    })
    ...
    FinancingWithBLOBs selectByPrimaryKey(Integer id);

    @UpdateProvider(type=FinancingSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(FinancingWithBLOBs record);
    ...
    int updateByPrimaryKeyWithBLOBs(FinancingWithBLOBs record);
